...
public class Driver { //beginning of class
    ...
    public static void main(String[] Strings){  //Beginning of main method
		...
		double monthlySavingsAmount; //Declaration of input data monthlySavingsAmount
		...
		//Preparation of a double output data finalBalance
		double finalBalance; //Declaration of output data finalBalance
        finalBalance = 0; //Initialization of output data finalBalance
